...
class VendorBillDetail(models.TransientModel):
    ...
    vendor_amount_bill = fields.Float("Bill Due")
    vendor_amount_paid = fields.Float("Bill Paid")
    vendor_amount_due = fields.Float("Bill Amount")
    vendor_bill_amount_refunded = fields.Float("Refunded Amount")
    ...
    bucket_type_id = fields.Many2one('bucket.type', 'Bucket')
    bucket_sub_type = fields.Many2one('bucket.type','Sub Bucket')
